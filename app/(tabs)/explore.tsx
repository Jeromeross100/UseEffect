  ...
  return (
    ...
    >
      <ThemedView style={styles.titleContainer}>
        <ThemedText
          type="title"
          // If you want a font, uncomment this safe fallback:
          // style={{ fontFamily: Platform.select({ ios: 'Avenir Next', android: 'sans-serif', default: 'system-ui' }) }}
        >
          Explore
        </ThemedText>
      </ThemedView>
      ...
      <Collapsible title="Light and dark mode components">
        <ThemedText>
          ...
          hook lets you inspect what the user&apos;s current color scheme is, and adjust UI colors accordingly.
        </ThemedText>
